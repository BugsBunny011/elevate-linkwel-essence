  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-navy-dark/95 backdrop-blur-lg shadow-lg py-3"
          : "bg-transparent py-5"
      }`}
    >
      <div className="container mx-auto flex items-center justify-between section-padding">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            to="/contact"
            className="gold-gradient text-navy-dark font-body font-semibold text-sm px-6 py-2.5 rounded-sm uppercase tracking-wider hover:opacity-90 transition-opacity"
          >
            Get a Quote
          </Link>
        </div>
        ...
        {mobileOpen && (
          ...
          >
            <div className="flex flex-col items-center gap-6 py-8">
              ...
              <Link
                to="/contact"
                className="gold-gradient text-navy-dark font-semibold text-sm px-6 py-2.5 rounded-sm uppercase tracking-wider"
              >
                Get a Quote
              </Link>
            </div>

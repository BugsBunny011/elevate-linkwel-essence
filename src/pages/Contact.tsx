...
const Contact = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Contact Linkwel Engineers | Get a Free Lift Quote</title>
        <meta name="description" content="Get in touch with Linkwel Engineers for a free lift quote. Delhi NCR's trusted elevator manufacturer — installation, AMC & custom solutions." />
        ...
        <meta property="og:description" content="Get a free quote and consultation from top elevator and industrial crane manufacturers in India." />
      ...
      <section className="pt-32 pb-20 navy-gradient">
        <div className="container mx-auto section-padding text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-heading font-bold text-gold-light mb-6">
            Contact <span className="text-gold-gradient">Linkwel Engineers</span>
          </h1>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@linkwelengineers.com" className="text-muted-foreground font-body text-sm mt-1 block hover:text-accent transition-colors">info@linkwelengineers.com</a>
                    </div>
                  </div>
                </div>
